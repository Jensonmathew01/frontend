...
<Carousel responsive={responsive}>
  ...
  <div className='product'>
    <img src="https://www.swisstimehouse.com/img/m/8.webp" alt="" style={{ width: "100%", height: "200px" }}/>
    <div className='description'>
    
     </div>
  </div>
  <div className='product'><img src="https://www.swisstimehouse.com/img/m/11.webp" alt=""  style={{ width: "100%", height: "200px" }}  />
  <div className='description'>
    
     </div>
  </div>
  <div className='product'><img src="https://www.swisstimehouse.com/img/cms/site%20april%202020/july%20New%20Folder/tissot-logo-min.webp" alt=""  style={{ width: "100%", height: "200px" }} />
  <div className='description'>
